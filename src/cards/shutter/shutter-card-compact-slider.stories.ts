...
import "./shutter-card-compact-slider.js";
...
const meta: Meta = {
  title: "Cards/ShutterCardCompactSlider",
  component: "fr-shutter-card-compact-slider",
  render: (args) => {
    const el = document.createElement("fr-shutter-card-compact-slider") as ShutterCardBase;
