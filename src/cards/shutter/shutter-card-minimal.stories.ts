...
import "./shutter-card-minimal.js";
...
const meta: Meta = {
  title: "Cards/ShutterCardMinimal",
  component: "fr-shutter-card-minimal",
  render: (args) => {
    const el = document.createElement("fr-shutter-card-minimal") as ShutterCardBase;
